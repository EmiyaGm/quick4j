...
<head>
    ...
    <link href="assets/global/css/pages/tasks.css" rel="stylesheet" type="text/css" />
    <link href="assets/global/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color" />
...
<div class="header navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="header-inner">
        ...
        <a href="javascript:;" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            <img
                    src="assets/global/img/menu-toggler.png" alt="" />
        </a>
        ...
        <ul class="nav navbar-nav pull-right">
            <li class="dropdown user">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                    <img alt="" src="assets/global/img/avatar1_small.jpg"/>
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu" id="page-sidebar-menu">
                ...
                <li class="start active">
                    <a href="rest/page/dashboard_2" id="btn-dashboard">
...
<![endif]-->
<script src="assets/global/plugins/jquery-1.10.2.min.js" type="text/javascript"></script>
<script src="assets/global/plugins/jquery-migrate-1.2.1.min.js" type="text/javascript"></script>
<script src="assets/global/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js" type="text/javascript"></script>
<script src="assets/global/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="assets/global/plugins/bootstrap-hover-dropdown/twitter-bootstrap-hover-dropdown.min.js" type="text/javascript"></script>
...
<script type="text/javascript" src="assets/apps/js/index.js"></script>
